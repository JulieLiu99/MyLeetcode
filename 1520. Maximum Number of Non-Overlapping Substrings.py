class Solution:
    def maxNumOfSubstrings(self, s: str) -> List[str]:
        ...
        3) Loop through all the ranges generated from #2, so it's O(26). We also spent O(26log26) to sort it.
        
        Space O(26) to store (start, end) for each char, and O(26) to store pairs:[l, r].
